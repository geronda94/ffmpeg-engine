    ...
    try:
        ...
        guidelines = {
            "Russian": (
                ...
                "5. РИТМ: МИНИМУМ знаков препинания. Запятую или точку ставь ТОЛЬКО если без них теряется смысл. Тире и двоеточия НЕ используй для создания пауз — Edge TTS сам справляется с интонацией. Избегай лишних символов. Текст должен звучать естественно и быстро, без искусственных пауз.\n"
            ),
            "English": (
